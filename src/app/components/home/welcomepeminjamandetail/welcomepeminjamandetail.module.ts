...
import { WelcomepeminjamandetailRoutingModule } from './welcomepeminjamandetail-routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    WelcomepeminjamandetailRoutingModule,
    TableModule,
    FileUploadModule,
    FormsModule,
    ButtonModule,
	...
	declarations: [WelcomepeminjamandetailComponent],
  providers: [KategoriService, PinjambaranguserService, BarangService]
})
export class WelcomepeminjamandetailModule { }
